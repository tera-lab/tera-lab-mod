...
module.exports = function Cosplay(mod) {
  ...
  mod.hook('S_USER_EXTERNAL_CHANGE', mod.majorPatchVersion > 76 ? 7 : 6, event => applyPreset(event))

  mod.hook('S_UNICAST_TRANSFORM_DATA', mod.majorPatchVersion > 76 ? 5 : 4, event => {
    if (!event.unk2)
